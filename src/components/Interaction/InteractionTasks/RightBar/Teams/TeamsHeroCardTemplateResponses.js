...
export const TeamsHeroCardTemplateResponses = ({
	element,
	taskList,
	onChangeProperty,
	...
	return (
		<Wrapper>
			...
			{element.property[1].mode === ResponseMode.Static ? (
				<TextArea
					rows={3}
					value={element.JSON.body[0].columns[0].items[0].text}
			...
			{element.property[1].mode === ResponseMode.Static ? (
				<TextArea
					rows={3}
					value={element.JSON.body[0].columns[0].items[1].text}
					onChange={onChangeThumbnailLargeText}
				/>
			) : (
				<Select
			...
			{element.property[1].mode === ResponseMode.Static ? (
				<TextArea
					rows={3}
					value={element.JSON.body[2].text}
					onChange={onChangeThumbnailLargeText}
				/>
			) : (
				<Select
      ...
      <Tag>Buttons Responses</Tag>
			...
			{element.property[2].mode === ResponseMode.Static ? (
				<Input
					style={{ marginTop: '8px' }}
					value={element.JSON.body[3].columns[0].items[0].actions[0].title}
			...
			{element.property[4].mode === ResponseMode.Static ? (
				<Input
					style={{ marginTop: '8px' }}
					value={element.JSON.body[3].columns[1].items[0].actions[0].title}
					onChange={onChangeButtonText}
				/>
			) : (
				<Select
